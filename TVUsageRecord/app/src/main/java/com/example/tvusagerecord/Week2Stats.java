...
public class Week2Stats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String[] row = durationFileManager.getValuesForCertainWeekInSeconds(table, 2);
        ...
        pieChart.setCenterText("Week 2 Usage Stats");
        ...
        pieChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                Toast.makeText(Week2Stats.this, "Period: " + period + "\n"
